...
const Footer = () => {
  return (
    <div className="lg:flex md:flex flex-col hidden mt-10">
      ...
      <div>
        <div className="flex justify-center space-x-28 h-[242px] w-full ">
          <div className="flex flex-col justify-center h-[262] mt-2 bg-white ">
          ...
          <div className="flex flex-col justify-center max-w-full  h-[262] mt-2 bg-white ">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h4 className="text-gray-400 font-light text-sm mt-1">
              what a good day :L
            </h4>
          </div>
        </div>
